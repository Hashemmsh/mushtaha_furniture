...
class ProductController extends Controller
{
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $product->update($data);
        return redirect()->route('admin.products.index')->with('msg' , 'Product Update successfully')->with('type' , 'success');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.products.index')->with('msg', 'products restored successfully')->with('type', 'warning');
    }
